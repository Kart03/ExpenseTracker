    ...
    var body: some View {
        ...
        .background {
            RoundedRectangle(cornerRadius: 16)
                .stroke(isSelected ? category.color : .gray, lineWidth: 1)
                .overlay {
                    RoundedRectangle(cornerRadius: 16)
                        .foregroundColor(isSelected ? category.color : .clear)
                }
        }
        .frame(height: 44)
        .onTapGesture {
...
#Preview {
    ...
    return FilterCategoriesV(selectedCategories: $vm.selectedCategories)
}
